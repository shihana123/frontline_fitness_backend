...
urlpatterns = [
    ...
    path('mainProgramList', MainProgramListView.as_view(), name='main-program-list'),
    path('mainprogramCreate', MainProgramCreateView.as_view(), name='main-program-create'),
    path('deleteMainProgram/<int:pk>/', DeleteMainProgramView.as_view(), name='main-program-delete'),
    path('mainProgramDetail/<int:pk>/', DetailsMainProgramView.as_view(), name='main-program-details'),
    path('mainprogramUpdate/<int:pk>/', UpdateMainProgramView.as_view(), name='main-program-update'),
    ...
    path('program-count/', ProgramCountView.as_view(), name='program-count'),
    ...
    path('vmcclientList', VMCClientListView.as_view(), name='vmc-client-list'),
    ...
    path('trainerpausesclientList', PauseClientListTrainerView.as_view(), name='pause-client-list'),
    ...
    path('fetchActiveClientsgraph/<str:month>/<int:year>/', FetchActiveClientsGraphView.as_view(), name='fetch-active-clients-graph'),
